...
import GamePlayerStateController from "./GamePlayerStateController.hbermj"
...
export default class GamePlayer extends GamePlayerStateController {
    ...
    setMoneyNum(num = 0) {
        ...
        cc.find("nodeInfo/nodeMoney/labelMoney",this.node).getComponent(cc.Label).string = GameLogic.Instance().GetMoneyShortString(num)
    ...
    removePlayer() {
        ...
        cc.find("nodeInfo/nodeMoney/labelMoney",this.node).getComponent(cc.Label).string = 0
    ...
    setScoreNum(num = 0) {
        ...
        cc.find("nodeInfo/nodeScore/labelScore",this.node).getComponent(cc.Label).string = num
    }
