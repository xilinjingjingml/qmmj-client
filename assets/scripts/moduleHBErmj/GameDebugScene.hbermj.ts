...
export class GameDebugScene extends BaseComponent {
    ...
    __bindButtonHandler() {
        ...
        BaseFunc.AddClickEvent(this.btnDebugLeft, this.node, "GameDebugScene.hbermj", "onPressDebugLeft");
        BaseFunc.AddClickEvent(this.btnDebugRight, this.node, "GameDebugScene.hbermj", "onPressDebugRight");        
    }
    onPressDebugLeft() {
    ...
    start () {        
        ...
        // let nodeSceneScript = nodeScene.getComponent("GameScene.hbermj")
