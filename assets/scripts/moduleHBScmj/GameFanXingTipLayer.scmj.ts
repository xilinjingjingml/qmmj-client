...
export default class GameFanXingTipLayer extends BaseComponent {
    ...
    @property
    thisComponentName:string = "GameFanXingTipLayer.scmj"
    btnMenu1: any;
    btnMenu2: any;
    labelMenu1: any;
    labelMenu2: any;
    ...
    onOpenScene(){
        if (GameLogic.Instance().serverInfo.gameId == 396) {            
            this.scrollViewContent.height = 4520
            for(let i=1;i<6;i++){
                BaseFunc.SetFrameTextureLocal(this["fanxing_content_"+i].getComponent(cc.Sprite),"moduleHBScmjRes/images/WanFa/xlch_"+i, (sprite) => {
                })
            }
