...
import GameScene from "./GameScene.jxmj"
...
export class GameDebugLayer extends BaseComponent {
    ...
    __bindButtonHandler() {
        ...
        BaseFunc.AddClickEvent(this.btnDebugLeft, this.node, "GameDebugLayer.jxmj", "onPressDebugLeft");
        BaseFunc.AddClickEvent(this.btnDebugRight, this.node, "GameDebugLayer.jxmj", "onPressDebugRight");        
    }
