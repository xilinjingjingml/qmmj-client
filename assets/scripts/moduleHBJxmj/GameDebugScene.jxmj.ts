...
export class GameDebugScene extends BaseComponent {
    ...
    __bindButtonHandler() {
        ...
        BaseFunc.AddClickEvent(this.btnDebugLeft, this.node, "GameDebugScene.jxmj", "onPressDebugLeft");
        BaseFunc.AddClickEvent(this.btnDebugRight, this.node, "GameDebugScene.jxmj", "onPressDebugRight");        
    }
    onPressDebugLeft() {
    ...
    start () {        
        ...
        // let nodeSceneScript = nodeScene.getComponent("GameScene.jxmj")
