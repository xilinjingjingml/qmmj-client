...
export class GameDebugScene extends BaseComponent {
    ...
    __bindButtonHandler() {
        ...
        BaseFunc.AddClickEvent(this.btnDebugLeft, this.node, "GameDebugScene.gdmj", "onPressDebugLeft");
        BaseFunc.AddClickEvent(this.btnDebugRight, this.node, "GameDebugScene.gdmj", "onPressDebugRight");        
    }
    onPressDebugLeft() {
    ...
    start () {        
        ...
        // let nodeSceneScript = nodeScene.getComponent("GameScene.gdmj")
