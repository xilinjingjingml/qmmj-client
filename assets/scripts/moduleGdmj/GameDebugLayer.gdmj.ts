...
import GameScene from "./GameScene.gdmj"
...
export class GameDebugLayer extends BaseComponent {
    ...
    __bindButtonHandler() {
        ...
        BaseFunc.AddClickEvent(this.btnDebugLeft, this.node, "GameDebugLayer.gdmj", "onPressDebugLeft");
        BaseFunc.AddClickEvent(this.btnDebugRight, this.node, "GameDebugLayer.gdmj", "onPressDebugRight");        
    }
